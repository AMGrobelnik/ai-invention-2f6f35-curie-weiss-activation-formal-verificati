# CWA Iter2 Exp2: IFT Benchmark + Extended LM + 100x J-LR on RTX 5090
...
Tests the Curie-Weiss Activation (CWA), a novel activation function from statistical physics, on Shakespeare language models, finding J can be steered toward criticality with amplified learning rate.
