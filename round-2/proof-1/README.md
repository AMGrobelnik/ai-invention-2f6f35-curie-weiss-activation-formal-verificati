...
Formally proves in Lean 4 that CWA's iterative solver converges correctly using the actual code tolerance, and that the warm-start gradient approximation has error shrinking geometrically with iteration count.
