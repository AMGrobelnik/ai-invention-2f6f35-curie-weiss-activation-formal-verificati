...
Produces five paper-ready outputs for the CWA paper: power analysis (~1pp limit), gradient-stability table, four figure captions, verified abstract numbers with sources, and a corrected theorem count.
...
- `art_5zKSer_FGOKx` — shift-ablation
- `art_v26XKv4_F1RM` — depth-sweep
- `art_xd3tmcyckf00` — memory-benchmark
- `art_V46hELP73T_t` — cwa-lm-results
- `art_kKv207AAQYq2` — mlp-experiment
