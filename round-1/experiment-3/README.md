...
We trained a small transformer using a novel physics-inspired 'Curie-Weiss Activation' and compared its text prediction performance against standard alternatives like GELU on Tiny Shakespeare and WikiText-2.
