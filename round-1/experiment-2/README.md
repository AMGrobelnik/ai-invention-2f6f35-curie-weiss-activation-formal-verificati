# CWA ResNet-20 CIFAR-100 Width Analysis + Overhead Benchmark
...
Tests a novel 'Curie-Weiss Activation' (CWA) function that uses mean-field neural coupling to improve neural network training on image classification, comparing it to standard activations across different network widths.
