...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 5 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_2.md` — 4 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_3.md` — 3 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_proof_1.md` — 6 prompts
    ...
    - `3_gen_art/` — 5 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_2.md` — 15 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_3.md` — 17 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_proof_1.md` — 8 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 4 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_proof_1.md` — 2 prompts
    - `3_gen_art/` — 4 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_2.md` — 13 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_proof_1.md` — 5 prompts
  ...
  - round_3
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_3/2_gen_plan/gen_plan_proof_1.md` — 2 prompts
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_3/3_gen_art/gen_art_evaluation_1.md` — 9 prompts
      - `chat/prompts/2_test_idea/round_3/3_gen_art/gen_art_experiment_1.md` — 12 prompts
      - `chat/prompts/2_test_idea/round_3/3_gen_art/gen_art_proof_1.md` — 6 prompts
  ...
  - round_4
    ...
    - `3_gen_art/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_4/3_gen_art/gen_art_evaluation_1.md` — 8 prompts
      - `chat/prompts/2_test_idea/round_4/3_gen_art/gen_art_experiment_1.md` — 10 prompts
  ...
  - round_5
    ...
    - `3_gen_art/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_5/3_gen_art/gen_art_evaluation_1.md` — 7 prompts
      - `chat/prompts/2_test_idea/round_5/3_gen_art/gen_art_experiment_1.md` — 14 prompts
...
- **3. report_results** — `gen_paper_repo`
  ...
  - `2_gen_demo_art/` — 11 task(s)
    ...
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_3.md` — 6 prompts
    ...
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_3.md` — 12 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_4.md` — 9 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_5.md` — 11 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_6.md` — 6 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_7.md` — 5 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_8.md` — 5 prompts
